...
export const StripePaymentForm = (props: Props) => {
  ...
  return (
    <form
      ...
      class="flex flex-col p-4 probot-input w-full items-center"
    >
      ...
      <Show when={message()}>
        <div class="probot-input-error-message mt-4 text-center animate-fade-in">
          {message()}
        </div>
      </Show>
    </form>
